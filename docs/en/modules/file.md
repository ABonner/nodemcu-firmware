...
#### Parameters
- `n_or_str`:
	- if nothing passed in, read up to `LUAL_BUFFERSIZE` bytes (default 1024) or then entire file (whichever is smaller)
	...
	- if passed a string "str", then read until 'str', `LUAL_BUFFERSIZE`, or EOF is reached
